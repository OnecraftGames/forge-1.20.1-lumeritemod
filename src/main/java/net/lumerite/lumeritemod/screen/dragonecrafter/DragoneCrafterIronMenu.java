...
public class DragoneCrafterIronMenu extends AbstractContainerMenu {

    public final DragoneCrafterIronEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public DragoneCrafterIronMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(6));
    }

    public DragoneCrafterIronMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DragoneCrafterIronMenu.get(), pContainerId);
        checkContainerSize(inv, 6);
        blockEntity = ((DragoneCrafterIronEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlock.DRAGONE_CRAFTER_IRON.get());
    }
