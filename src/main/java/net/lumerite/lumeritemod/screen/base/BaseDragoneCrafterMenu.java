package net.lumerite.lumeritemod.screen.base;
...
public class BaseDragoneCrafterMenu<T extends BaseDragoneCrafterEntity> extends AbstractContainerMenu {
    ...
    public BaseDragoneCrafterMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data, Block block, MenuType<? extends BaseDragoneCrafterMenu> menu) {
