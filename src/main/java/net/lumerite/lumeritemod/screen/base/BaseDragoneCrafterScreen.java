...
public class BaseDragoneCrafterScreen<T extends BaseDragoneCrafterMenu> extends AbstractContainerScreen<T> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(LumeriteMod.MOD_ID, "textures/gui/dragone_crafter_gui.png");

    public BaseDragoneCrafterScreen(T pMenu, Inventory pPlayerInventory, Component pTitle) {
